  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center justify-center gap-2 rounded-md bg-gold-gradient px-5 py-3 text-sm font-bold text-[var(--navy-deep)] transition-transform hover:-translate-y-0.5"
      >
