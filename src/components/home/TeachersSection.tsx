    ...
    <section id="teachers" className="bg-white py-24">
      <Container className="grid gap-12 lg:grid-cols-[0.75fr_1.25fr] lg:items-start">
        <div className="max-w-xl lg:sticky lg:top-24">
          ...
          {/* <a
            href="#news"
            className="mt-8 inline-flex items-center gap-3 rounded-full bg-[var(--gold-light)] px-5 py-3 text-sm font-bold text-[var(--navy-deep)] transition-transform hover:-translate-y-0.5"
          >
            View all
          ...
          {teachers.map((teacher) => (
            ...
            >
              <div className="relative h-56 sm:h-60 lg:h-56 overflow-hidden rounded-[28px]">
                ...
                />
                <div className="absolute bottom-0 left-0 right-0 h-28 bg-[linear-gradient(180deg,transparent,rgba(2,31,61,0.7))] rounded-b-[28px]" />
                <div className="absolute bottom-3 left-3 right-3 rounded-[16px] bg-white px-3 py-2 text-[var(--navy)] shadow-[0_10px_20px_rgba(2,31,61,0.12)]">
