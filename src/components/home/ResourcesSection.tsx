    ...
    <section className="bg-[var(--surface)] py-24">
      <Container>
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <a
            href="#contact"
            className="inline-flex items-center justify-center rounded-full bg-[var(--gold-light)] px-5 py-3 text-sm font-bold text-[var(--navy-deep)] transition-transform hover:-translate-y-0.5"
          >
            Browse all
          </a>
        </div>
          ...
          {books.map((book) => (
            ...
            >
              ...
              <div className="mt-4 flex items-center justify-between gap-4">
                ...
                <a
                  href="#contact"
                  className="rounded-full bg-[var(--gold-light)] px-4 py-2 text-xs font-bold uppercase tracking-[0.18em] text-[var(--navy-deep)]"
                >
                  Buy now
                </a>
              </div>
