    ...
    <section id="about" className="relative overflow-hidden bg-white py-24">
      ...
      <Container className="grid gap-10 lg:grid-cols-[0.98fr_1.02fr] lg:items-center">
        <div className="max-w-xl">
          ...
          <a
            href="/about-us"
            className="mt-8 inline-flex items-center gap-3 rounded-full bg-gold-gradient px-5 py-3 text-sm font-bold text-[var(--navy-deep)] transition-transform hover:-translate-y-0.5"
          >
            Learn more
      ...
      {/* <Container className="mt-10 grid gap-6 md:grid-cols-2">
        {applicationCards.map((card) => (
          ...
          >
            ...
            <a
              href={card.href}
              className="mt-6 inline-flex items-center justify-center rounded-full bg-[var(--gold-light)] px-5 py-3 text-sm font-bold text-[var(--navy-deep)] transition-transform hover:-translate-y-0.5"
            >
              {card.label}
            </a>
          </article>
