    ...
    <main className="bg-white">
      ...
      <section className="bg-[var(--surface)] py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <h1 className="text-4xl text-[var(--navy)] md:text-5xl font-bold mb-6">
            A Premium Education and Language Pathway Center
          </h1>
          <p className="text-lg text-[var(--muted)] md:text-xl leading-8 max-w-4xl mx-auto">
      ...
      <section className="py-16 px-6">
        <div className="max-w-5xl mx-auto space-y-6 text-[var(--muted)] text-base md:text-lg leading-8">
          <p>
      ...
      <section className="bg-[var(--surface)] py-16 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-start">
          <div>
            <h2 className="text-3xl font-bold text-[var(--navy)] mb-5">
          ...
          <div className="rounded-3xl bg-white p-8 shadow-sm border border-[var(--border)]">
            <h3 className="text-xl font-semibold text-[var(--navy)] mb-5">
      ...
      <section className="py-16 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-[var(--muted)] text-base md:text-lg leading-8">
      ...
      <section className="bg-[var(--surface)] py-16 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-[var(--navy)] mb-10">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-10">
            {[
              ...
              <div
                key={item.title}
                className="rounded-2xl bg-white p-6 shadow-sm border border-[var(--border)]"
              >
          ...
          <div className="rounded-3xl bg-white p-8 md:p-10 shadow-sm border border-[var(--border)]">
            <p className="text-[var(--muted)] text-base md:text-lg leading-8">
            ...
            <p className="mt-5 text-[var(--muted)] text-base md:text-lg leading-8">
