...
export default function ContactUsPage() {
  return (
    <main className="bg-[var(--surface)]">
      <section className="bg-[var(--navy)] px-6 py-18 text-white sm:py-24">
      ...
      <Container className="grid gap-8 px-6 py-14 lg:grid-cols-[1.1fr_0.9fr] lg:py-20">
        ...
        <aside className="rounded-3xl bg-white p-7 shadow-[0_16px_45px_rgba(2,31,61,0.1)] ring-1 ring-[var(--border)] sm:p-8">
          <p className="text-sm font-black uppercase tracking-[0.2em] text-[var(--gold-deep)]">
            Visit our school
          </p>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-7 inline-flex w-full items-center justify-center gap-2 rounded-md bg-gold-gradient px-5 py-3 text-sm font-black text-[var(--navy-deep)] transition-transform hover:-translate-y-0.5"
          >
            <MapPin
              className="h-4 w-4"
              aria-hidden="true"
