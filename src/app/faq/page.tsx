...
export const metadata: Metadata = {
  title: "FAQ | Edukatory Language School",
  description:
    "Frequently asked questions about Edukatory Language School programs, English development, GED preparation, university pathways, assessment, enrollment, tuition, and academic support in Pattaya, Thailand.",
};
...
const faqSections = [
  {
    ...
    items: [
      {
        question: "What is Edukatory Language School (ELS)?",
        answer:
      ...
      {
        question: "What makes ELS different from other language schools?",
        answer:
      ...
      {
        question: "Where is Edukatory Language School located?",
        answer:
      ...
      },
      {
        ...
        answer: "ELS is open Monday to Saturday from 8:30 AM to 7:00 PM.",
      },
      {
        question: "What age groups does ELS accept?",
        answer:
  ...
  },
  {
    ...
    items: [
      {
        question: "What languages do you teach at ELS?",
        answer:
      ...
      {
        question: "Are short-term intensive courses available?",
        answer:
      ...
      {
        question: "Does ELS provide one-on-one tutoring?",
        answer:
      ...
      {
        question: "Does ELS offer customized learning plans?",
        answer:
      ...
      {
        question: "Is there homework or self-study support?",
        answer:
      ...
      {
        question: "Are native English-speaking teachers available?",
        answer:
      ...
      {
        question: "Can students join without strong English skills?",
        answer:
      ...
      {
        question:
          "Is ELS suitable for homeschool or alternative education students?",
        answer:
  ...
  },
  {
    ...
    items: [
      {
        question: "How do I know which level to enroll in?",
        answer:
      ...
      {
        question: "Why do students need assessment before enrollment?",
        answer:
      ...
      {
        question: "What documents are needed for enrollment?",
        answer:
      ...
      {
        question: "Is the assessment fee deductible from tuition?",
        answer:
          "Yes. The Assessment and Placement fee is fully deductible from tuition upon enrollment into an eligible ELS program.",
      },
      {
        question: "Can students transfer from another school or GED program?",
        answer:
  ...
  },
  {
    ...
    items: [
      ...
      {
        question:
          "Can I pause my course if I go on vacation or business travel?",
        answer:
  ...
  {
    title: "Parent Support & Academic Monitoring",
    items: [
      {
      ...
      {
        question: "Can parents speak directly with teachers or academic staff?",
        answer:
      ...
      {
        question: "How does ELS monitor student progress?",
        answer:
      ...
      {
        question: "What happens if a student is academically struggling?",
        answer:
  ...
  },
  {
    ...
    items: [
      ...
      {
        question: "Are books and exam fees included?",
        answer:
  ...
  {
    title: "GED & University Pathways",
    items: [
      {
        question:
          "What is the difference between GED and a traditional high school diploma?",
        answer:
      ...
      {
        question: "Is the GED accepted by universities?",
        answer:
      ...
      {
        question: "Does ELS guarantee GED passing or university admission?",
        answer:
      ...
      {
        question: "Does ELS help students with university pathways?",
        answer:
      ...
      {
        question:
          "Can students under 16 years old enroll in GED-related programs?",
        answer:
  ...
  },
  {
    ...
    items: [
      {
        question: "How do I apply to ELS?",
        answer:
      ...
      {
        question: "Can international students enroll at ELS?",
        answer:
            ...
            <div key={section.title}>
              ...
              <div className="space-y-4">
                {section.items.map((faq, faqIndex) => {
                  const accordionId = `faq-${sectionIndex}-${faqIndex}`;
